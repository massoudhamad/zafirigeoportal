...
echo "-----------------------------------------------------"
echo "STARTING zafirigeoportal RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./zafirigeoportal/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED zafirigeoportal RESTORE $(date)"
echo "-----------------------------------------------------"
